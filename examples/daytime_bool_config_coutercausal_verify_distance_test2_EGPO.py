...
from Test2_simulation_EGPO import run_simulation
from metadrive.component.sensors.rgb_camera import RGBCamera
from metadrive.policy.EGPO import EGPO
from metadrive.policy.custom_policy import CumtomPolicy
import pandas as pd
import random
import argparse
...
# 检查前100条数据并更新参数
for index, row in df.iloc[524:531].iterrows():
