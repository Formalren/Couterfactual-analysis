...
def run_simulation(config, args):
    ...
    config_file_exists = os.path.isfile('output_verify_filter_new9.csv')
    ...
    try:
        ...
        for i in range(1, 1000):
            # 这里需要加入某个策略
            o, r, tm, tc, info = env.step(IDMPolicy(env.agent, 3))
        ...
        with open('output_verify_filter_new9.csv', 'a', newline='', encoding='utf-8') as f:
