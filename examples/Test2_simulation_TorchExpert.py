...
import cv2
import numpy as np
from metadrive.envs.Test2_metadrive_env_torchpolicy import MetaDriveEnv
...
def run_simulation(config, args):
    ...
    config_file_exists = os.path.isfile('output_verify_filter_new10.csv')
    ...
    try:
        ...
        for i in range(1, 1000):
            # 这里需要加入某个策略
            o, r, tm, tc, info = env.step(torch_expert(env.agent))
        ...
        with open('output_verify_filter_new10.csv', 'a', newline='', encoding='utf-8') as f:
