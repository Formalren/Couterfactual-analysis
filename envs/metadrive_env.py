...
METADRIVE_DEFAULT_CONFIG = dict(
    ...
    # ===== PG Map Config =====
    map=5,  # int or string: an easy way to fill map_config
    ...
    map_config={
        ...
        BaseMap.GENERATE_CONFIG: random.randint(3, 7),
        BaseMap.LANE_NUM: random.randint(2, 4),
        BaseMap.LANE_WIDTH: random.randint(2, 4),
    ...
    # ===== Traffic =====
    #traffic_density=random.uniform(0, 0.5),
    traffic_density=0.1,
    ...
    # ===== Object =====
    #accident_prob=random.uniform(0, 0.5),  # accident may happen on each block with this probability, except multi-exits block
    accident_prob=0.,
